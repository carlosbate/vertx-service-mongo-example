...
public class FooDatabaseServiceVertxEBProxy implements FooDatabaseService {
  ...
  public FooDatabaseServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public FooDatabaseServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
